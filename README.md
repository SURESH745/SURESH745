...
I am a highly motivated **Data Scientist & Web Developer** with expertise in **Machine Learning, Deep Learning, and Full-Stack Development**. My focus is on building **AI-powered applications, predictive models, and scalable web solutions**.  

📌 **Key Strengths:**  
✔️ **Proficient in ML & Deep Learning** (TensorFlow, Scikit-Learn, Pandas)  
✔️ **End-to-End Data Science Pipelines** (Data Preprocessing, Model Deployment)  
✔️ **Full-Stack Web Development** (MERN Stack, React, Node.js)  
✔️ **Strong Problem-Solving & Analytical Thinking**  
...
🔹 [Titanic Survival Prediction](https://github.com/SURESH745/Titanic-Prediction-Project) 🚢  
